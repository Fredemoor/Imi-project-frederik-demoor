...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Imi.Project.Mobile.Android.dll" comes first in this list. */
		"Imi.Project.Mobile.Android.dll",
		"FluentValidation.dll",
		"FormsViewGroup.dll",
		"FreshIOC.dll",
		"FreshMvvm.dll",
		"Howest.Prog.Xamarin.UriSourceExtensions.dll",
		"Imi.Project.Mobile.dll",
